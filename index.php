...
<html>
	...
	<body>
		<div class="container">
			...
			<div class="row twelve columns tabs--venue">

				<div class="tab wrapper">
					<a href="#tab1" class="tabs__tab">
						<h6>Tab 1</h6>
					</a>
					<a href="#tab2" class="tabs__tab">
						<h6>Tab 2</h6>
					</a>
					<a href="#tab3" class="tabs__tab">
						<h6>Tab3</h6>
					</a>
				</div>		

				<div class="content-box tabbed-content wrapper">

					<div class="tabbed-content__holder slider">
		...
		<script type="text/javascript" src="tabbed-content-init.js"></script>
